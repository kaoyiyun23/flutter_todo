...
import 'package:flutter_application_2/screens/colorful_demo_screen.dart';
import 'package:flutter_application_2/screens/todo_input_demo_screen.dart';
import 'package:flutter_application_2/screens/count_todo_demo_screen.dart';
...
void main() {
  runApp(
    //每一個Provider都是一個共享狀態
    //MultiProvider裡面可以放provider，分享多個狀態給Flutter主應用
    MultiProvider(
      providers: [
